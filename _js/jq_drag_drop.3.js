DragDrop = {
	...
	setupElement: function (event) {
		...
		switch(setElementType) {
			...
			case 'text_box':
				...
				// console.log("txtbox border width before parseInt: " + inputBorderWidth);
				var inputBorderWidth = parseInt(inputBorderWidth);
				// var inputBorderWidth = Math.ceil(parseFloat(inputBorderWidth));
				// console.log("txtbox border width: " + inputBorderWidth);
				var inputBorderRadius = $selectedElement.find('input').css('border-radius');
				// console.log("txtbox border radius before parseInt: " + inputBorderRadius);
				var inputBorderRadius = parseInt(inputBorderRadius);
				// console.log("txtbox border radius: " + inputBorderRadius);
	...
	textBoxSave: function (event) {
		...
		console.log("TextBox BDwidth: " + newBorderThickness);
